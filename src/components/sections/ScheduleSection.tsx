...
export const ScheduleSection = () => {
  const schedules = [
    ...
    },
    {
      ...
      date: 'Selama pendaftaran berlangsung',
      time: '08.00 - 14.30 WITA',
      desc: 'Panitia melakukan pencocokan berkas fisik pendaftar dan memverifikasi validitas data administrasi calon siswa baru.',
      status: 'Selama Pendaftaran',
    ...
    },
    {
      ...
      desc: 'Hasil keputusan seleksi berkas diumumkan secara terbuka di papan pengumuman sekolah serta dapat dicek langsung di web ini.',
      status: 'Mendatang',
    ...
    },
    {
      ...
      desc: 'Calon siswa yang dinyatakan diterima wajib melapor diri, melengkapi dokumen administrasi, serta mengukur seragam sekolah.',
      status: 'Mendatang',
      statusColor: 'bg-slate-100 text-slate-800 border-slate-200',
    },
    {
      ...
      date: '13 Juli 2026',
      time: '07.00 WITA - Selesai',
      desc: 'Hari pertama sekolah, dimulai dengan kegiatan Masa Pengenalan Lingkungan Sekolah (MPLS) guna pembentukan karakter siswa baru.',
      status: 'Mendatang',
      statusColor: 'bg-slate-100 text-slate-800 border-slate-200',
    },
  ];
